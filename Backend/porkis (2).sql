...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2024 a las 00:40:02
...
(2, 'Maria', 'Lopez', 'maria.lopez@pasteleria.com', '$2a$10$wGf9jgYqpeYHT5ZJNX5tBOP2F4mYrSVzlyAoWa.0te1qMumCESn4i', 'dueño');
...
--
ALTER TABLE `materia_prima`
  MODIFY `id_MateriaPrima` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
